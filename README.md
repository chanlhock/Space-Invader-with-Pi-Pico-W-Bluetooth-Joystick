...
\t &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp- Anatole France
</p>
...
## :scroll: Description
Space Invaders Python code generated by DeepSeek AI that interfaces with a Raspberry Pi Pico W joystick through Bluetooth. \
The program runs on Raspberry Pi Pico W (Bluetooth Joystick) and Raspberry Pi 5 (Space Invaders).

## :computer: Development Platform
Program code is generated for Thonny using MicroPython. \
I started prompt coding in the morning of 4th March 2026. \
It took me only 3 hours to complete this.\
This included the time it took for me to do some final fine tuning manual tweak of the code to get the end results I wanted.\
I have tested on Raspberry Pi Pico W and Raspberry Pi 5 running Thonny.
